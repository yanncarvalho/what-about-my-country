...
class PopulateDBTest(SimpleTestCase):
  ...
  @patch('backend.api.models_country.Country.all_keys_n_name_from_net', return_value = [])
  ...
  @patch('backend.api.populate.Populate._is_population', False)
  ...
  @patch('backend.api.populate.Populate._is_population', True)
